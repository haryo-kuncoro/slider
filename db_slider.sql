...
) ENGINE = InnoDB AUTO_INCREMENT = 3935 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = COMPACT;
...
INSERT INTO `tbl_wisudawan` VALUES (3607, 1, '2021020006', 'Wisudawan 04', 'Ayah 04', 'Ibu 04', 'Medan / 02 Januari 2001', '', '', NULL, 'Analisis Perbandingan Metode Canny, Sobel dan Laplacian of Gaussian (LoG) dalam Mendeteksi Tepi Logo Provinsi di Indonesia', 'Cumlaude', 'Akuntansi', '1');
